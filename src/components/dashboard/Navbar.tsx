        ...
        <>
            <nav className='block drop-shadow-lg bg-gray-200 p-4'>
                <ul className="flex justify-around font-bold">
                    ...
                    <Link className='my-auto duration-300 hover:scale-105 hover:text-green-900' href="/dashboard">Dashboard</Link>
                    <Link className='my-auto duration-300 hover:scale-105 hover:text-green-900' href="/projects">Search Projects</Link>
